...
📋 功能简介：
    基于 Google Gemini AI 的智能本地化质量审计工具，支持 Excel 批量处理
    和术语一致性检查。自动识别语法错误、术语不一致、上下文适配问题。
...
2. 配置 API Key
   • 在界面输入框填入 Gemini API Key

3. 选择文件
   • 点击"选择待审 Excel"加载翻译文件
   • (可选) 点击"选择术语表"加载术语对照表
...
本工具仅作为效率辅助，AI 审计结果可能存在误判，请务必人工复核后使用。
用户需自行承担使用本工具产生的风险。
