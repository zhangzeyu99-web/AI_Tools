...
# ==============================================================================
# 🧠 PROMPT 区域 (已修复视频输出格式，强制中文分析+Tab分隔)
# ==============================================================================
...
[Header Row]
Time\tLocation\t⚠️ Issue Type\t❌ Original Text\t✅ Better English\t💡 Deep Analysis (Chinese)
...
class VideoLocalizationApp(ctk.CTk):
    def __init__(self):
        ...
        self.title("Gemini 3 LQA 终极修正版 (v15.0)")
